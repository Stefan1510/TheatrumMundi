...
public class ElementSliderToValueY : MonoBehaviour
{
    ...
    public void ChangeElementPosition()
    {
        ...
        dragdrop.GetComponent<RectTransform>().anchoredPosition = new Vector2(dragdrop.GetComponent<RectTransform>().anchoredPosition.x, this.GetComponent<Slider>().value*200);
